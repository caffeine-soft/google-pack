...
pub fn add_v1_signature_files(zip_contents: &mut Vec<crate::zip::File>, keys: &Keys) -> Result<()> {
    ...
    // Then add them
    zip_contents.push(crate::zip::File {
...
fn create_signature_file(files: &Vec<crate::zip::File>, manifest: &String) -> String {
...
fn create_manifest(files: &Vec<crate::zip::File>) -> String {
...
fn create_manifest_entry(file: &crate::zip::File) -> String {
    let file_name = &file.path;
